...
public class runCompare {
    ...
    public static void main(String[] args) throws InterruptedException {
        ...
        List<String> resultsFromUI = new ArrayList<>();
        List<String> resultsFromServices = new ArrayList<>();
        List<String> resultsFromExcel = new ArrayList<>();
        ...
        Thread t1 = new Thread(new Runnable() {
            ...
            public void run() {
                for(String url: urls) {
                    ...
                    try {
                        resultsFromUI.addAll(getActualDataFromFundPageAsAlIst(url));
                    } catch (IOException e) {
        ...
        Thread t2 = new Thread(new Runnable() {
            ...
            public void run() {
                for(String url: urls) {
                    System.out.println("Running from :" + url);
                        resultsFromServices.addAll(Arrays.asList(services));
                    }
            }
        });
        ...
        Thread t3 = new Thread(new Runnable() {
            ...
            public void run() {
                for(String url: urls) {
                    System.out.println("Running from :" + url);
                    resultsFromExcel.addAll(Arrays.asList(excel));
                }
            }
        });
        ...
        System.out.println(resultsFromUI);
        System.out.println(resultsFromServices);
        System.out.println(resultsFromExcel);
    }
}
